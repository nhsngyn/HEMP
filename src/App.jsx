      ...
      <>
        ...
        >
          ...
          <div className="flex w-full min-h-0" style={{ gap: 'calc(16px * var(--scale))', flex: '2.9 0 0' }}>
            ...
            <div className="h-full bg-[#ffffff10] rounded-2xl relative overflow-hidden shadow-lg" style={{ width: '52%' }}>
            ...
            <div className="h-full bg-[#ffffff10] rounded-2xl relative overflow-hidden shadow-lg shrink-0 my-auto" style={{ width: '48%' }}>
              <RadarChart />
            </div>
          ...
          {/* 2. 하단 영역 (Sankey) - 60% */}
          <div className="w-full bg-[#ffffff10] rounded-2xl relative overflow-hidden shadow-lg min-h-0" style={{ flex: '6.0 0 0' }}>
            <SankeyChart />
          </div>
        </section>
